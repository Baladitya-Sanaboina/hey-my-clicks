/*
 * Copyright (c) 2017 Meghana Priyanka❤️
 * Author: Meghana Priyanka❤️
...
function fotofly_fn_hamburgermenu() {
  ...
  if (header1.length) {
    ...
    if ($data1 === "transdark" || $data1 === "nonedark") {
    ...
    if ($data2 === "transdark" || $data2 === "nonedark") {
      mobNav.css({ backgroundColor: "#fff" });
    }
